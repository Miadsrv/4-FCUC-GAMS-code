...
*$call =xls2gms r=generators_c!be2:bh14 i=Input_Lapalma.xlsx o=block_max.inc
$include block_max.inc
;

table k_option(i,b,tr) slope of each generator cost curve block
*$call =xls2gms r=generators_c!aw2:bc290 i=Input_Lapalma.xlsx o=k.inc
$include k.inc
;
parameter k(i,b);
...
*$call =xls2gms r=generators_c!bj2:bp770 i=Input_Lapalma.xlsx o=start_up_sw.inc
...
*$call =xls2gms r=generators_c!br2:bz14 i=Input_Lapalma.xlsx o=start_up_sl.inc
$include start_up_sl.inc
;

table aux2(i,column)
*$call =xls2gms r=generators_c!d2:e14 i=Input_Lapalma.xlsx o=aux2.inc
$include aux2.inc
;
...
table aux3(i,column)
*$call =xls2gms r=generators_c!g2:h14 i=Input_Lapalma.xlsx o=aux3.inc
$include aux3.inc
;
...
table aux4(i,tr)
*$call =xls2gms r=generators_c!j2:N14 i=Input_Lapalma.xlsx o=aux4.inc
$include aux4.inc
;
...
table aux5(i,tr)
*$call =xls2gms r=generators_c!p2:t14 i=Input_Lapalma.xlsx o=aux5.inc
$include aux5.inc
;
...
table aux6(i,tr)
*$call =xls2gms r=generators_c!v2:z14 i=Input_Lapalma.xlsx o=aux6.inc
$include aux6.inc
;
...
table aux7(i,tr)
*$call =xls2gms r=generators_c!ab2:af14 i=Input_Lapalma.xlsx o=aux7.inc
$include aux7.inc
;
...
table aux8(i,tr)
*$call =xls2gms r=generators_c!ah2:al14 i=Input_Lapalma.xlsx o=aux8.inc
$include aux8.inc
;
...
table aux9(i,tr)
*$call =xls2gms r=generators_c!an2:ar14 i=Input_Lapalma.xlsx o=aux9.inc
$include aux9.inc
;
...
*$call =xls2gms r=generators_c!at2:au14 i=Input_Lapalma.xlsx o=aux10.inc
$include aux10.inc
;
...
*$call =xls2gms r=generators_c!cb2:ce14 i=Input_Lapalma.xlsx o=cost_coefs.inc
$include cost_coefs.inc
;
table auxinertia(i,column)
*$call =xls2gms r=dynamics!a2:b14 i=Input_Lapalma.xlsx o=auxinertia.inc
...
*$call =xls2gms r=dynamics!d2:e14 i=Input_Lapalma.xlsx o=auxmbase.inc
...
table auxk(i,column)
*$call =xls2gms r=dynamics!g2:h14 i=Input_Lapalma.xlsx o=auxk.inc
$include auxk.inc
;
...
*$call =xls2gms r=RES!a2:g170 i=Input_Lapalma.xlsx o=RES_seasons.inc
$include RES_seasons.inc
;
table wind_det_aux(t,days,seasons,column)
*$call =xls2gms r=RES!i2:N674 i=Input_Lapalma.xlsx o=aux_wind_seasons.inc
...
*$call =xls2gms r=RES!p2:u674 i=Input_Lapalma.xlsx o=solar_seasons.inc
...
*$call =xls2gms r=load!a2:g170 i=Input_Lapalma.xlsx o=d_seasons.inc
